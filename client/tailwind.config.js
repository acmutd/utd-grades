    ...
    extend: {
      colors: {
        ...
        pagination: {
          ...
          "border-active": "var(--pagination-border-active)",
          bg: "var(--pagination-bg)",
          "bg-disabled": "var(--pagination-bg-disabled)",
          "bg-active": "var(--pagination-bg-active)",
          text: "var(--pagination-text)",
          "text-disabled": "var(--pagination-text-disabled)",
          "text-active": "var(--pagination-text-active)",
